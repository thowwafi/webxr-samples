...
function onSessionStarted(session) {
  ...
  if (choosenObject == "flower") {
    ...
    arObject.addNode(flower);
  } else if (choosenObject == "headset-url") {
    let flower = new Gltf2Node({
      url:
        "https://bzid-demo-assets-singapore.s3-ap-southeast-1.amazonaws.com/headset.gltf",
    });
    arObject.addNode(flower);
  } else if (choosenObject == "headset-downloaded") {
    let flower = new Gltf2Node({
